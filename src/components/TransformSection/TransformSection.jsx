...
const TransformSection = ({scrollTo, style}) => {
  ...
  return (
      <div className="transform" id="transform">
          <div className="transform-text-container transform-1" data-aos="fade-up" data-aos-duration="1000">
              <h3 className="ff-gillroy-l sec-color fs-2m">Dont be <span className="blk-color ff-gillroy-b">ordinary</span>...</h3>
          </div>
          <div className="transform-text-container transform-2" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">
          ...
          <div className="transform-text-container transform-3" >
              <h3 className="ff-gillroy-l sec-color fs-l" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="750">Make a statement with <br /> <span className="blk-color">visuals branding</span> production</h3>
